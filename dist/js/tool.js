...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-custom-action-field', __webpack_require__(4));
    Vue.component('custom-action', __webpack_require__(7));
    Vue.component('action-modal', __webpack_require__(12));
});
...
Component.options.__file = "resources/js/components/CustomAction/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-67208356", Component.options)
  } else {
    hotAPI.reload("data-v-67208356", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        hasCustomActionField: function hasCustomActionField() {

            var customAction = this.resource.fields.find(function (field) {
                return field.component == 'custom-action-field';
            }).customAction;
...
var render = function() {
  ...
  return _vm.hasCustomAction
    ? _c(
        "div",
        { staticClass: "flex" },
        _vm._l(_vm.customAction, function(action, index) {
          return _c("custom-action", {
            key: index,
            attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-67208356", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/CustomAction/Action.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-06010743", Component.options)
  } else {
    hotAPI.reload("data-v-06010743", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: ['resource', 'resourceName', 'resourceId', 'customAction'],
    ...
    methods: {
        ...
        shouldDisplayCustomAction: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2() {
                var _this = this;

                var rules, ruleCheck, _loop, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, rule, _ret;

                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                rules = JSON.parse(this.customAction.rules);
                                ruleCheck = true;
                                _loop = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _loop(rule) {
                                    var field;
                                    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _loop$(_context2) {
                                        while (1) {
                                            switch (_context2.prev = _context2.next) {
                                                case 0:
                                                    field = _this.resource.fields.find(function (field) {
                                                        return field.attribute == rule.attributes.name;
                                                    });
                                                    ...
                                                    if (_this.resourceFields) {
                                                        _context2.next = 5;
                                                        break;
                                                    }

                                                    _context2.next = 5;
                                                    return _this.resourceCheck();

                                                case 5:

                                                    field = _this.resourceFields.find(function (field) {
                                                        return field.attribute == rule.attributes.name;
                                                    });
                            ...
                            case 8:
                                ...
                                rule = _step.value;
                                return _context3.delegateYield(_loop(rule), 't0', 11);

                            case 11:
                                _ret = _context3.t0;
                                _context3.t1 = _ret;
                                _context3.next = _context3.t1 === 'continue' ? 15 : _context3.t1 === 'break' ? 16 : 17;
                                break;
            ...
            function shouldDisplayCustomAction() {
                return _ref2.apply(this, arguments);
            }

            return shouldDisplayCustomAction;
        }(),
        ...
        confirmActionModal: function confirmActionModal() {

            this.indexPageRefresh();

            this.closeActionModal();
        },
        indexPageRefresh: function indexPageRefresh() {
              ...
              directives: [
                {
                  ...
                  value: _vm.__(_vm.customAction.name),
                  expression: "__(customAction.name)",
                  modifiers: { click: true }
                }
              ],
              staticClass:
                "inline-flex appearance-none cursor-pointer text-70 ml-3",
              class: _vm.icon.class,
              attrs: { disabled: _vm.processing },
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.openActionModal($event)
                }
              }
            },
            [
              _c(
                "svg",
                {
                  ...
                  attrs: {
                    ...
                    viewBox: _vm.icon.viewBox
                  }
                },
                [_c("path", { attrs: { d: _vm.icon.path } })]
              )
            ]
          ),
          _vm._v(" "),
                  ...
                  _vm.actionModalOpen
                    ? _c("action-modal", {
                        attrs: {
                          ...
                          "custom-action": _vm.customAction
                        },
                        on: {
                          close: _vm.closeActionModal,
                          confirm: _vm.confirmActionModal
                        }
                      })
                    : _vm._e()
                ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-06010743", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/CustomAction/ActionModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e026e64c", Component.options)
  } else {
    hotAPI.reload("data-v-e026e64c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    props: ['resource', 'resourceName', 'resourceId', 'resourceFields', 'customAction'],
    ...
    methods: {
                        ...
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return Nova.request().get('/nova-api/' + this.resourceName + '/' + this.resourceId + '/update-fields', {
                                    ...
                                    if (error.response.status == 404) {
                                        ...
                                        return _this.$router.push({ name: 404 });
                                    }
                                });
                            ...
                            case 2:
                                ...
                                if (fields.Tabs) {
                                    ...
                                    this.localFields = Object.keys(fields.Tabs.fields).map(function (key) {
                                        return fields.Tabs.fields[key];
                                    });
                                } else {
        ...
        prepareCustomActionFields: function prepareCustomActionFields() {

            var fields = JSON.parse(this.customAction.changes);

            var customActionFields = [];
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _context3.prev = 2;
                                _context3.next = 5;
                                return Nova.request().post('/nova-api/' + this.resourceName + '/' + this.resourceId, this.resourceFormData, {
                                    params: {
                                        editing: true,
                                        editMode: 'update'
                                    }
        ...
        findComponentValue: function findComponentValue(component) {
        ...
        componentIs: function componentIs(attributes) {

            if (!this.loading) {

                var field = this.localFields.find(function (field) {
                    return field.attribute == attributes.name;
                });

                return 'form-' + field.component;
            }
        },
        componentField: function componentField(attributes) {
        ...
        generateValue: function generateValue(field, attributes) {
    ...
    computed: {
        resourceFormData: function resourceFormData() {
            var _this2 = this;
            ...
            var changes = JSON.parse(this.customAction.changes);

            fields.forEach(function (field) {

                var cField = changes.find(function (component) {
                    return component.attributes.name == field.attribute;
                });

                if (cField) {

                    var fieldValue = _this2.generateValue(field, cField.attributes);

                    formData.append(field.attribute, fieldValue);
                } else {

                    var _fieldValue = _this2.findComponentValue(field.component);

                    /* if the value is null return empty string */
                    formData.append(field.attribute, field[_fieldValue] ? String(field[_fieldValue]) : '');
                }
            });
...
var render = function() {
  ...
  return _c("modal", { on: { "modal-close": _vm.handleClose } }, [
    _c(
      ...
      {
        ref: "form",
        staticClass: "bg-white rounded-lg shadow-lg overflow-hidden max-w-full",
        on: {
        ...
        _c(
          ...
          [
            _c(
              ...
              [
                _vm.customActionFields.length == 0
                  ? _c("div", {
                      staticClass: "p-8",
                      domProps: { innerHTML: _vm._s(_vm.modalMessage) }
                    })
                  : _vm._l(_vm.customActionFields, function(field, index) {
                      return _c(_vm.componentIs(field.attributes), {
                        key: index,
                        tag: "component",
                        attrs: {
                          ...
                          "resource-id": _vm.resourceId,
                          "resource-name": _vm.resourceName,
                          field: _vm.componentField(field.attributes)
                        },
                        on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e026e64c", module.exports)
  }
}
